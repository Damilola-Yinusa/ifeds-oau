    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ai_influencer' => [
                ...
                'show_condition'   => MarketplaceHelper::isRegistered('ai-influencer'),
            ],
            'documents' => [
                'parent_key'       => null,
                'key'              => 'documents',
            ...
            'proposal_creator' => [
                ...
                'route'            => 'dashboard.user.proposal.index',
                'route_slug'       => null,
                'label'            => 'Proposal Creator',
                'data-name'        => 'proposal_creator',
                ...
                'extension'        => null,
                'active_condition' => [
                    'dashboard.user.proposal.*',
                ],
                'show_condition' => true,
            ],
            'pitch_deck_creator' => [
                'parent_key'       => null,
                'key'              => 'pitch_deck_creator',
                'route'            => 'dashboard.user.pitch-deck.index',
                'route_slug'       => null,
                'label'            => 'Pitch Deck Creator',
                'data-name'        => 'pitch_deck_creator',
            ...
            'api_integration_creatify' => [
                ...
                'label'            => EngineEnum::CREATIFY->label(),
                'icon'             => null,
                'svg'              => null,
                'order'            => 68,
                'is_active'        => true,
